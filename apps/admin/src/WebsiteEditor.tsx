          ...
          <div className="website-preview-stage">
            <div className={`website-preview ${device}`} style={previewStyle}>
              ...
              <header className="preview-site-header">
                <div className="preview-site-brand"><span className="preview-logo">{brand.initials}</span><span><strong>{brand.name}</strong><small>{brand.tagline}</small></span></div>
              ...
              <footer className="preview-site-footer"><div><span className="preview-logo">{brand.initials}</span><span><strong>{brand.name}</strong><p>{brand.description}</p></span></div><nav><span>Home</span><span>Menu</span><span>Our Story</span><span>Stores</span></nav></footer>
              </>}
            </div>
          </div>
