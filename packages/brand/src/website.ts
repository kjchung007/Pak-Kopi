...
export type WebsiteStore={id:number;name:string;address:string;phone:string;opening:string;closing:string;image?:string;acceptingPickup?:boolean;featured?:boolean;state?:string;city?:string;latitude?:number|null;longitude?:number|null};
